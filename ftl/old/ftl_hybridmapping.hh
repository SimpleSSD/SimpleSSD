...
class HybridMapping : virtual public MappingTable {
 private:
  ...
  // merge functions
  bool check_direct_erase(const Addr target_block, const Addr target_group,
                          const Addr *target_lpns);
  bool check_switch_merge(const Addr target_block, const Addr target_group,
                          const Addr *target_lpns);
  bool check_reorder_merge(const Addr target_block, const Addr target_group,
                           const Addr *target_lpns);
  bool check_partial_merge(const Addr target_block, const Addr target_group,
                           const Addr *target_lpns);
  bool check_full_merge(const Addr target_block, const Addr target_group,
                        const Addr *target_lpns);
